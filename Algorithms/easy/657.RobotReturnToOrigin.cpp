...
/**
 * Runtime: 12 ms, faster than 97.08% of C++ online submissions for Robot Return
 * to Origin. Memory Usage: 10 MB, less than 97.56% of C++ online submissions
...
/**
 * Runtime: 16 ms, faster than 84.92% of C++ online submissions for Robot Return
 * to Origin. Memory Usage: 10.2 MB, less than 82.93% of C++ online submissions
 * for Robot Return to Origin.
 */
class Solution {
 public:
